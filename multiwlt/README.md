...
[All five de-identified RTPLANs](data/README.md#all-five-rtplans) are also available separately, including the combined 16-field gantry/couch/collimator alpha plan (collection v2). Only the initial R6 acquisition has measured results; the traditional Standard-WLT has a separate original CT/structure reference.
